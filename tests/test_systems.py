...
from atomic.systems import System, get_system, hydrogen_like, list_systems
...
def test_provenance_cites_codata():
    ...
    assert d.mu_ratio.provenance.error_estimate is not None
...
def test_nuclear_radius_triton_is_cited_literature():
    ...
    assert "Angeli" in q.provenance.method
